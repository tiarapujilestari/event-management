...
async function main() {
    ...
    // ---- Organizer ----
    const organizerPassword = await bcryptjs_1.default.hash('Organizer123!', 10);
    ...
    const eventData = [
        {
            ...
            isFree: false,
            price: 350000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785693064/marron5_z9kdqf.png",
        },
        {
            ...
            isFree: false,
            price: 400000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785693345/raisa-with-simphony_v7eshp.png",
        },
        {
            ...
            isFree: false,
            price: 380000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785693062/the-script_skk88v.png",
        },
        {
        ...
        },
        {
            ...
            isFree: false,
            price: 500000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785693063/blackpink-born-pink_tkfiuc.png",
        },
        {
            ...
            isFree: false,
            price: 480000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785693065/bts-arirang_aebc1n.png",
        },
        {
            ...
            isFree: false,
            price: 420000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785693063/isyana-saraswati-opera_o6bwcg.png",
        },
        // ---- Technology Events ----
        {
        ...
        // ---- Business & Startup Events ----
        {
            ...
            isFree: false,
            price: 300000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785692731/gopay-startup-innovation_qxwwvd.png",
        },
        {
        ...
        },
        {
            ...
            isFree: false,
            price: 270000,
            bannerUrl: "https://res.cloudinary.com/kivc3ajv/image/upload/v1785692731/tokopedia-startup-innovation_h4oa3u.png",
        },
        // ---- Sports Events ----
        {
    ...
    for (const ev of eventData) {
        ...
        const event = await prisma.event.upsert({
            ...
            create: {
                ...
                endDate: new Date(Date.now() + 1000 * 60 * 60 * 24 * 30 + 1000 * 60 * 60 * 6),
                isFree: ev.isFree,
                maxPurchase: 4,
