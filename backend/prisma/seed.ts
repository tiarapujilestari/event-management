...
async function main() {
  ...
  const categories = await Promise.all(
    ['Music', 'Technology', 'Business', 'Sports', 'Arts & Culture', 'Food & Drink'].map((name) =>
  ...
  const cities = await Promise.all(
    ['Jakarta', 'Bandung', 'Surabaya', 'Yogyakarta', 'Bali', 'Pekanbaru'].map((name) =>
      prisma.city.upsert({
        where: { name },
        update: {},
  ...
  const eventData = [
    {
      ...
      isFree: false,
      price: 350000,
      bannerUrl: "/images/maroon5-greatest-hits.jpg",
    },
    {
      ...
      isFree: false,
      price: 400000,
      bannerUrl: "/images/raisa-opera-kehidupan.jpg",
    },
    {
      ...
      isFree: false,
      price: 380000,
      bannerUrl: "/images/the-script-greatest-hits.jpg",
    },
    {
      ...
      isFree: false,
      price: 450000,
      bannerUrl: "/images/taylor-swift-eras-tour.jpg",
    },
    {
      ...
      isFree: false,
      price: 320000,
      bannerUrl: "/images/my-chemical-romance.jpg",
    },
    {
      ...
      isFree: false,
      price: 500000,
      bannerUrl: "/images/blackpink-born-pink.jpg",
    },
    {
      ...
      isFree: false,
      price: 480000,
      bannerUrl: "/images/bts-epilogue-reunion.jpg",
    },
    {
      ...
      isFree: false,
      price: 420000,
      bannerUrl: "/images/isyana-saraswati-opera.jpg",
    },
    // ---- Technology Events ----
    {
      ...
      isFree: false,
      price: 250000,
      bannerUrl: "/images/gopay-summit-fintech.jpg",
    },
    {
      ...
      isFree: false,
      price: 280000,
      bannerUrl: "/images/grab-summit-innovation.jpg",
    },
    {
      ...
      isFree: false,
      price: 200000,
      bannerUrl: "/images/tokopedia-summit-innovation.jpg",
    },
    // ---- Business & Startup Events ----
    {
      ...
      isFree: false,
      price: 300000,
      bannerUrl: "/images/gopay-startup-innovation.jpg",
    },
    {
      ...
      isFree: false,
      price: 320000,
      bannerUrl: "/images/grab-startup-innovation.jpg",
    },
    {
      ...
      isFree: false,
      price: 270000,
      bannerUrl: "/images/tokopedia-startup-innovation.jpg",
    },
    // ---- Sports Events ----
    {
      ...
      isFree: false,
      price: 150000,
      bannerUrl: "/images/billiard-golf-padel.jpg",
    },
    // ---- Arts & Culture Events ----
    {
      ...
      isFree: false,
      price: 180000,
      bannerUrl: "/images/art-seni-culture.jpg",
    },
    {
      ...
      isFree: false,
      price: 500000,
      bannerUrl: "/images/tech-summit-indonesia.jpg",
    },
    // ---- Food & Drink Events ----
    {
      ...
      isFree: false,
      price: 0,
      bannerUrl: "/images/talamdurian.png",
    },
  ];
